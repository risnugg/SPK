                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('index.php/auth/registration'); ?>">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="id" name="username" placeholder="Username" value="<?= set_value('username'); ?>">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="tahun" name="tahun" placeholder="Tahun" value="<?= set_value('tahun'); ?>">
